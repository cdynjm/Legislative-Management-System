                ...
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        ...
                        @foreach(Logo::get() as $logo)
                            @if($logo->logo != null)
                                <img src="{{ asset('storage/logo/'.$logo->logo) }}" alt="..." class="w-100 border-radius-lg shadow-sm">
                            @endif
                            @if($logo->logo == null)
                                <img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png" alt="..." class="w-100 border-radius-lg shadow-sm">                         
                            @endif
                        @endforeach
                       
                        <a href="#" id="uploadprofile" class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                        ...
                        @if(Auth::user()->type == 0)  
                            ...
                            <img src="{{ asset('storage/photo/'.Auth::user()->Members->photo) }}" alt="..." class="w-100 border-radius-lg shadow-sm">
                ...
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="mission">{{ 'Change New Password' }}</label>
                                <div class="@error('user.mission')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Password" id="name" name="password" value="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.vision')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="vision" rows="3" placeholder="" name="vision">{{ $vision }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.mission')border border-danger rounded-3 @enderror">
                            <textarea class="form-control" id="mission" rows="3" placeholder="" name="mission">{{ $mission }}</textarea>
                        </div>
                    </div>
                    @endif
