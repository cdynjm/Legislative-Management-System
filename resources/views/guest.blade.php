        ...
        <div class="page-header">
            <div class="container">
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-12">
                            <div class="card mt-8 shadow-none">
                                <div class="card-body p-4 mt-2 bg-white border-radius-xl">
                                        <p class="fw-bolder">Approved Ordinances</p>
                                        <div class="table-responsive p-0">
                                            <table class="table align-items-center mb-0" id="guest-table-result">
                                                    <thead>
                                                        <tr>
